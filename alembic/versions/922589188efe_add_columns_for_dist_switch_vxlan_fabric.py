...
def upgrade():
    ...
    op.add_column('device', sa.Column('infra_ip', sqlalchemy_utils.types.ip_address.IPAddressType(length=50), nullable=True))
    op.add_column('device', sa.Column('oob_ip', sqlalchemy_utils.types.ip_address.IPAddressType(length=50), nullable=True))
