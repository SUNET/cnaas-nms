...
from cnaas_nms.api.auth import AuthApi
...
api.add_resource(DeviceByIdApi, '/api/v1.0/devices/<int:device_id>')
api.add_resource(DevicesApi, '/api/v1.0/devices')
...
api.add_resource(InterfaceApi, '/api/v1.0/devices/<string:hostname>/interfaces')

api.add_resource(MgmtdomainsApi, '/api/v1.0/mgmtdomains')
api.add_resource(MgmtdomainByIdApi, '/api/v1.0/mgmtdomains/<int:mgmtdomain_id>')
