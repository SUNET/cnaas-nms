    ...
    def delete(self, mgmtdomain_id):
        ...
        with sqla_session() as session:
            ...
            if instance:
                ...
                add_sync_event(instance.device_a.hostname, "mgmtdomain_deleted", get_oauth_identity())
                instance.device_b.synchronized = False
                add_sync_event(instance.device_b.hostname, "mgmtdomain_deleted", get_oauth_identity())
    ...
    def put(self, mgmtdomain_id):
        ...
        with sqla_session() as session:
            ...
            if instance:
                ...
                if changed:
                    instance.device_a.synchronized = False
                    add_sync_event(instance.device_a.hostname, "mgmtdomain_updated", get_oauth_identity())
                    instance.device_b.synchronized = False
                    add_sync_event(instance.device_b.hostname, "mgmtdomain_updated", get_oauth_identity())
    ...
    def post(self):
        ...
        with sqla_session() as session:
            ...
            if required_in_data and required_in_json_data:
                ...
                add_sync_event(device_a.hostname, "mgmtdomain_created", get_oauth_identity())
                device_b.synchronized = False
                add_sync_event(device_b.hostname, "mgmtdomain_created", get_oauth_identity())
