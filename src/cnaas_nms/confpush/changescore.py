...
change_patterns = [
    ...
    {
        'name': 'name',
        'regex': re.compile(str(line_start + r"name")),
        'modifier': 0.0
    },
    {
        'name': 'comment',
        'regex': re.compile(str(line_start + r"!")),
        'modifier': 0.0
    },
    {
        'name': 'dot1x',
        'regex': re.compile(str(line_start + r"dot1x")),
        'modifier': 0.5
    },
    {
        'name': 'ntp',
        'regex': re.compile(str(line_start + r"ntp")),
        'modifier': 0.5
    },
    {
        'name': 'snmp',
        'regex': re.compile(str(line_start + r"snmp")),
        'modifier': 0.5
    },
    {
        'name': 'vrf',
        'regex': re.compile(str(line_start + r"vrf")),
        'modifier': 5.0
    },
    {
