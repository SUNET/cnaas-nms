    ...
    def __init__(self, user="cnaas", passwd="cnaas", database="cnaas"):
        ...
        self._postgres = subprocess.Popen(
            [
                ...
                "--rm",
                "-p",
                "{!s}:5432".format(self._port),
                "-e",
                "POSTGRES_USER={!s}".format(self._user),
                "-e",
                "POSTGRES_PASSWD={!s}".format(self._passwd),
                "-e",
                "POSTGRES_DB={!s}".format(self._database),
                "--name",
        ...
        subprocess.call(
            ["docker", "cp", "cnaas.sql", "postgres_{!s}:/".format(self._port)],
